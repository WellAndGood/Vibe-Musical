...
function goWiki() {
    ...
    if (termMatches === true) {
        ...
        exceptionHandler(term, accordionException, "_(accordion)")  // THESE DO NOT APPEAR TO WORK. 'Triangle' still returns a geometry article.
