...
// Heroku Init Button
herokuFinder = document.getElementById("herokuFinder")

//  DOM variables for Wikipedia API interaction
...
var hiddenUntilSearch = document.getElementById("hiddenUntilSearch")


// DOM variables for YouTube API interaction 
...
const herokuLink = "https://cors-anywhere.herokuapp.com/corsdemo"

herokuFinder.addEventListener("click", function() {
    window.open(herokuLink, '_blank').focus();
})
...
function goWiki() {
    ...
    if (termMatches === true) {
        ...
        errorMessage.textContent = ""
        hiddenUntilSearch.style.display = "block"
